...
def adam(x, dx, config=None):
  ...
  next_x = None
  _beta1t = config['beta1']
  _beta2t = config['beta2']
  #############################################################################
  ...
  _beta1t = 1 - (_beta1t**config['t'])
  _beta2t = np.sqrt(1 - (_beta2t**config['t']))
  config['learning_rate'] = config['learning_rate'] * (_beta2t/_beta1t)
